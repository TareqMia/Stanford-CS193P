...
struct EmojiArtDocumentView: View {
        ...
        GeometryReader { geometry in
            if #available(iOS 15.0, *) {
                ZStack {
                    ...
                    .gesture(tapToUnselectAllEmojis())
                ...
                .alert("Delete", isPresented: $showDeleteAlert, presenting: deleteEmoji) { emoji in
    ...
    private func panEmojiGesture(on emoji: EmojiArtModel.Emoji) -> some Gesture {
        DragGesture()
            .updating($gesturePanOffset) { latestDragGestureValue, gestureEmojiPanOffset, _ in
    ...
    // MARK: - Long press to Delete Emojis
    ...
    @available(iOS 15, *)
    private func deleteEmoji(for emoji: EmojiArtModel.Emoji) -> some View {
